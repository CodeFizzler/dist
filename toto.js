/*        Toto js V1.0
You Can Create Element And Style With Much Less Lines Of Code
And Also Use Inbuilt Functions That Impulse Your Performance.
Only By Toto
...
let toggle_value=1
function toggle(x,y){
let ea=document.querySelector(x)
let eb=document.querySelector(y)
...
toggle_value=0
return (ea.style.visibility="visible",
...
function setEvent(x){
return document.querySelector(x.element).addEventListener(x.event,x.do)

}


function createTag(y){
let e=document.createElement(y.create)
let o
for(i=0;i<Object.keys(y.attribute).length;i++){
o= e.setAttribute(Object.keys(y.attribute)[i],Object.values(y.attribute)[i])

}
return (
o,
//e.setAttribute(y.attribute[0],y.attribute[1]),
document.querySelector(y.append).appendChild(e),
...
return (
 ...
 e[i].style.animationduration=y.animationduration,
 e[i].style.animationfillmode =y.animationfillmode ,
 e[i].style.animationiterationcount =y.animationiterationcount ,
 e[i].style.animationname=y.animationname,
 e[i].style.animationplaystate =y.animationplaystate ,
 e[i].style.animationtimingfunction=y.animationtimingfunction,
 e[i].style.backfacevisibility=y.backfacevisibility,
 e[i].style.background =y.background ,
 e[i].style.backgroundattachment =y.backgroundattachment ,
 ...
 e[i].style.backgroundorigin=y.backgroundorigin,
 e[i].style.backgroundposition=y.backgroundposition,
 e[i].style.backgroundpositionx=y.backgroundpositionx,
 e[i].style.backgroundpositiony =y.backgroundpositiony ,
 e[i].style.backgroundrepeat =y.backgroundrepeat ,
 e[i].style.backgroundsize =y.backgroundsize ,
 e[i].style.border=y.border,
...
function center(x){
let parent=document.querySelector(x).parentElement.nodeName
createStyle(parent,{
display:"flex",
